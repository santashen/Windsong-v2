          ...
          <div class="auth-panel">
            <div class="auth-content">
              ...
              <p class="auth-description">
                投资就是买入企业的部分所有权，这里展示了我们持有的那些“下蛋金鹅”的最新健康报告。
              </p>
              <ul class="auth-points">
                <li>买股票就是买企业：视自己为企业的所有权人，将注意力放在生意本身</li>
                <li>聚焦股东回报与分红：将预期的现金流产出，作为衡量投资成效的核心锚点</li>
                <li>恪守安全边际与纪律：用理性的估值区间辅助决策，拒绝追涨杀跌</li>
              </ul>
            </div>
