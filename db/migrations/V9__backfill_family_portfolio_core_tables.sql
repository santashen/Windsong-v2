-- V9__backfill_family_portfolio_core_tables.sql
-- Force-recreate the normalized family portfolio tables so local databases
-- with mismatched legacy schemas can be reset to the current contract.
